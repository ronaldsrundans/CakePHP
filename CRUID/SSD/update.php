...
$man=$model=$status=$mem="";
$man_err = $mem_err = $model_err = $status_err = "";
...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    */
    ...
    if(empty($name_err) ){
        ...
        $sql = "UPDATE SSD SET ssdman=?, ssdmodel=?, ssdmem=?, ssdstatus=? WHERE ssdid=?";

        if($stmt = mysqli_prepare($link, $sql)){
		
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt,"ssssi", $param_man, $param_model, $param_mem, $param_status, $param_id);
