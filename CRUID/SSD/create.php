...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    */
    ...
    if(empty($name_err) && empty($man_err) && empty($model_err)&& empty($freq_err) && empty($socket_err)&& empty($cores_err)&& empty($threads_err)&& empty($year_err)){
        ...
        $sql = "INSERT INTO SSD (ssdman, ssdmodel, ssdmem,  ssdstatus) VALUES (?, ?, ?, ?)";
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h2>Create SSD Record</h2>
                    </div>
                    <p>Please fill this form and submit to add SSD record to the database.</p>
