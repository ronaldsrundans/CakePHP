...
var y = "8787878787878787";
var key ="0E329232EA6D0D73";
...
function xorfunc( arr1,  arr2, arr3,  n){
	for( i=0;i<n;i++){
...
function split(arr, arr1, arr2,  n){
	for( i=0;i<n;i++){
		arr1[i]=arr[i];
		arr2[i]=arr[i+n];
	}
...
function des(binTxt, binKey){
	...
	//document.getElementById("demo").innerHTML = binm.toString();
	return binKey;
}
/*	
	///cpp code
